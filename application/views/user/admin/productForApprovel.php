        ...
        <div class="container-fluid text-white">
            <div class="row p-t-b-10 ">
                <div class="col">
                    <h4>
                     ...
                     <span style="float:right;" class="skinnerapp_search"><a href="<?=base_url('index.php/user/productForApprovel')?>">Show All</a><input type="text" name="search" placeholder="Products" class="myTextInput"><button id="target">GO</button></span>
                </div>
            </div>
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link active" href="<?=base_url('index.php/user/productForApprovel')?>">Pandding</a>
                    </li>
                    <li>
...
<script>
  //$(".selctaction").on("change", function() {
$( ".selctaction" ).change(function() {
...
//alert(res[0]);
   if(res[0]==1 || res[0]==0){
      ...
      jQuery.ajax({
                type: "post",
                url: "<?php echo base_url(); ?>index.php/user/changestatus",
                dataType: 'json',
                data: {status:status},
  ...
  $( "#target" ).click(function() {
    ...
    jQuery.ajax({
                type: "post",
                url: "<?php echo base_url(); ?>index.php/user/searchproductForApprovel",
                dataType: 'json',
                data: {search:search},
                success: function(res) {
...
<script>
    ...
    $(document).ready(function() {
       ...
       $('body').on('change',".selctaction", function () {
