        ...
        <div class="container-fluid text-white">
            <div class="row p-t-b-10 ">
                <div class="col">
                   ...
                   <form method="post" action="<? echo base_url('/index.php/user/searchbymember')?>"><span style="float:right;"  class="skinnerapp_search"><input type="text" name="search" placeholder="Search"><button type="submit">Search</button></span></form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-md mr-3 mt-1 float-left">
                                                    <span class="avatar-letter avatar-letter-a  avatar-md circle"><img src="<?= base_url($subadminlist[$i]->proPicName); ;?>" alt=""></span>
                                                </div>
                                                <div>
                                                    <div class="username_div">
                                                        <strong><?=$subadminlist[$i]->userName?></strong>
                                                    </div>
                                                    <div class="email_box">  <?=$subadminlist[$i]->email?></div>
                                                </div>
                                            </td>
