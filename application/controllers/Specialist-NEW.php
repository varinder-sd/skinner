...
class Specialist extends CI_Controller
{
    ...
    public function gallery() {
        ...
        if (isset($_FILES['file']) && $_FILES['file'] != null) {
            ...
            $j = 0;
            $target_path = FCPATH . '/assets/gallery/';     // Declaring Path for uploaded images.
    ...
    public function viewproduct() {
        ...
        $data = $this->Special_model->view_product($id, $deviceId, $filterparam);
    ...
    public function patientproduct() {
        ...
        $this->load->library('pagination');
        $config = [
            'base_url' => base_url('index.php/Patient/patientproduct'),
            'per_page' => 5,
    ...
    public function setResponse() {
        ...
        $result = $this->Special_model->set_Response(
            $patientId,
            $createdate,
            $barcodeSrNo,
            $productName,
    ...
    public function chat() {
        ...
        foreach ($tokens as  $value) {
            ...
            if ($value->type == "IOS") {
		     ...
		     if (($result != false || $result != 'JSON_PARSING_ERROR') && sizeof($tokens) != 0) {
      

         $this->Patient_model->updateinboxmessage($userId);
     }
